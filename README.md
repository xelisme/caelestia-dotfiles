...
| File | Fungsi |
|---|---|
| `config/caelestia/hypr-vars.lua` | override variabel & keybind Hyprland (browser brave, terminal kitty, SUPER+W wallpaper, SUPER+SHIFT+N pindah window ke workspace, dll) |
